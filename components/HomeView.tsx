...
const Header: React.FC = () => {
  ...
  <header className="text-center mb-12">
    <h1 className="text-6xl font-extrabold text-slate-900 dark:text-slate-100 [text-shadow:0_2px_4px_rgba(0,0,0,0.1)]">{t('home_title')}</h1>
...
export const HomeView: React.FC<HomeViewProps> = ({ onSubjectSelect, onStartDrawing, onStartChat, onStartImageGeneration, onStartCanvas, onStartFlashAI, onStartPlanning, onStartConseils, onStartJeux, onStartVoiceAI, onStartImageEditing }) => {
  const { t } = useLocalization();
  return (
    ...
    <main>
       <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6 md:gap-8 mb-8">
            <CompactFeatureCard 
                ...
                description={t('home_brevetai_desc')}
            ...
            <CompactFeatureCard 
                ...
                title={t('home_canvasai')}
                description={t('home_canvasai_desc')}
            ...
            <CompactFeatureCard 
                ...
                title={t('home_flashai')}
                description={t('home_flashai_desc')}
            ...
            <CompactFeatureCard 
                ...
                title={t('home_planningai')}
                description={t('home_planningai_desc')}
            ...
            <CompactFeatureCard 
                ...
                title={t('home_conseilsai')}
                description={t('home_conseilsai_desc')}
      ...
      <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        {SUBJECTS.map((subject) => (
          <SubjectCard 
            ...
            subject={subject} 
            onSelect={() => {
              if (subject.nameKey === 'subject_arts') onStartDrawing();
              else if (subject.nameKey === 'subject_games') onStartJeux();
